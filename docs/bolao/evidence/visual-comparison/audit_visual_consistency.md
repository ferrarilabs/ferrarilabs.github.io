...
Gerado em 2026-08-20T19:04:15.135Z · commit `4dd5dca8` · referência visual: **copa2026** (golden master, ver CLAUDE.md).
...
| Componente | Propriedade | copa2026 | br2026 | cdb2026 | loterias/powerball |
|---|---|---|---|---|---|
| Topbar | padding | `10px 18px` | `10px 18px` | `10px 18px` | `30px 18px 10px` |
| Topbar | height | `108.5px` | `108.5px` | `108.5px` | `84.5px` |

## Divergências aprovadas (JUSTIFIED) — ver ALLOWLIST.json

| Componente | Propriedade | Justificativa |
|---|---|---|
| Topbar | gridTemplateColumns | Ratificado por Eduardo em 2026-08-20 (Issue #194), a partir do memo de ratificacao visual de 2026-08-08. O checador exige aprovador com nome e recusa auto-aprovacao -- esta entrada existe porque a decisao foi tomada, nao inferida. Mesma causa da DECISAO 1, medida por outra propriedade: o grid do cabecalho tem as mesmas quatro colunas nos quatro apps, mas no Powerball a coluna das abas/idiomas mede 0px porque nao existe conteudo nela -- e por isso as demais se redistribuem. Nao e um template de grid diferente; e o MESMO template com uma trilha vazia. Fixar os valores mantem o gate sensivel: uma mudanca real de layout do cabecalho em qualquer app quebra esta entrada. [docRef: Issue #194 (ratificacao 2026-08-20); memo VISUAL_RATIFICATION_REQUIRED.md DECISAO 1 (2026-08-08); owner: Platform; approvedBy: Eduardo; reviewDate: 2026-08-20; reviewBy: 2027-08-20] |
...
| padding | `10px 18px` | `10px 18px` | `10px 18px` | `30px 18px 10px` | DIVERGENT | — |
...
| height | `108.5px` | `108.5px` | `108.5px` | `84.5px` | DIVERGENT | VALUE DRIFT: entrada aprovada para "topbar:height" é expectedType="exact", mas o valor atual não bate mais com o autorizado (loterias/powerball: esperado "64.5px", atual "84.5px") — a entrada ficou desatualizada, precisa de nova revisão/atualização, não é mais coberta pela aprovação existente. |
| minHeight | `0px` | `0px` | `0px` | `0px` | EQUAL | — |
| gridTemplateColumns | `627.562px 177.578px 260.859px 142px` | `627.562px 177.578px 260.859px 142px` | `627.562px 177.578px 260.859px 142px` | `876.938px 120.219px 0px 210.844px` | JUSTIFIED | Ratificado por Eduardo em 2026-08-20 (Issue #194), a partir do memo de ratificacao visual de 2026-08-08. O checador exige aprovador com nome e recusa auto-aprovacao -- esta entrada existe porque a decisao foi tomada, nao inferida. Mesma causa da DECISAO 1, medida por outra propriedade: o grid do cabecalho tem as mesmas quatro colunas nos quatro apps, mas no Powerball a coluna das abas/idiomas mede 0px porque nao existe conteudo nela -- e por isso as demais se redistribuem. Nao e um template de grid diferente; e o MESMO template com uma trilha vazia. Fixar os valores mantem o gate sensivel: uma mudanca real de layout do cabecalho em qualquer app quebra esta entrada. [docRef: Issue #194 (ratificacao 2026-08-20); memo VISUAL_RATIFICATION_REQUIRED.md DECISAO 1 (2026-08-08); owner: Platform; approvedBy: Eduardo; reviewDate: 2026-08-20; reviewBy: 2027-08-20] |
...
| height | `35.5px` | `35.5px` | `35.5px` | `35.5px` | EQUAL | — |
| minHeight | `auto` | `auto` | `auto` | `auto` | EQUAL | — |
| gridTemplateColumns | `none` | `none` | `none` | `none` | EQUAL | — |
