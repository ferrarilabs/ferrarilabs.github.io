...
--
-- 20260812010000_expand_m9_outbox_events_and_delivery_attempts.sql
--
-- EXPAND stage M9 — outbox events and delivery attempts
--
...
--
-- ROLLBACK (FULL). FULL — DROP TABLE. Any undelivered event is lost, which is why rollback must happen while the outbox is empty.
--
-- ============================================================
