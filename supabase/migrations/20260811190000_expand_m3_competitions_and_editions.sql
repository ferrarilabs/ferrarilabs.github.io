...
--
-- 20260811190000_expand_m3_competitions_and_editions.sql
--
-- EXPAND stage M3 — competitions and editions
--
...
--
-- ROLLBACK (FULL). FULL. DROP TABLE competition_editions then competitions, in that order because the FK points that way. Safe while no pool references an edition, which is true until M4 runs. The reference rows are hand-authored and re-insertable from the same source, so nothing is lost.
--
-- ============================================================
