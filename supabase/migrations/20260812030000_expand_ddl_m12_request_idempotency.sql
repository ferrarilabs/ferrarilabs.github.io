...
--
-- 20260812030000_expand_ddl_m12_request_idempotency.sql
--
-- EXPAND stage DDL-M12 — request idempotency
--
...
--
-- ROLLBACK (FULL_BEFORE_BACKFILL). FULL while empty — DROP TABLE. Once it holds money-bearing records this becomes FORWARD_FIX_ONLY: dropping it converts every in-flight retry into a potential double payment, which is the exact failure the table exists to prevent.
--
-- ============================================================
