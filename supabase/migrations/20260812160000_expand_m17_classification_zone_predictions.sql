...
--
-- 20260812160000_expand_m17_classification_zone_predictions.sql
--
-- EXPAND stage M17 — classification zone predictions
--
...
--
-- ROLLBACK (FULL_BEFORE_BACKFILL). FULL. DROP TABLE bolao.classification_predictions. Every row is re-derivable from bolao_state['br2026'] for as long as legacy is retained, and legacy is retained.
--
-- ============================================================
