...
--
-- 20260811210000_expand_m5_payments_allocations_and_prizes.sql
--
-- EXPAND stage M5 — payments, allocations and prizes
--
...
--
-- ROLLBACK (FULL_BEFORE_BACKFILL). FULL before backfill. After backfill DATA-RESTORE-REQUIRED for any allocation an operator has since made, because an allocation records a human decision that cannot be recomputed.
--
-- ============================================================
