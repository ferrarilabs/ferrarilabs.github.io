...
A primeira execucao (2026-08-13, v4.187) foi revertida em 24s porque o comparador do log de
auditoria estourava quando o documento remoto nao publica `auditLog` — defeito latente, exposto
pela rota nova, corrigido em v4.188 e verificado em navegador real na rota LEGADA antes desta
troca. Ver a entrada de v4.188.
...
## v4.184 — 2026-08-10 — Os arquivos compartilhados estavam fora do cache-bust
