...
2026-08-01: MATCH_SCORING briefly dropped the `result` tier (5 pts for correct W/D/L sign, wrong
score) under the mistaken belief it didn't match the Copa's rules; reverted the same day once
Eduardo confirmed it's a real, intended CDB2026 rule (pasted the full scoring table directly).
See CHANGELOG.md and audit_scoring.py's own docstring for the full trail.
"""
import argparse
import json
import os
