window.CDB2026_I18N = {
  "pt-BR": {
    ...
    // rankMovementHtml() em app.js) -- CDB2026 não tem movimento de posição de time (mata-mata,
    // sem classificação de liga), só o do participante.
    ...
    receiptColTeamA: "Time A",
    receiptColTeamB: "Time B",
    ...
    confirmSaveLeg: "Salvar o placar {a} × {b} como resultado oficial desta partida?",
    ...
    auditAction_remove_tie: "Confronto removido",
    auditAction_save_leg: "Placar de partida lançado manualmente",
