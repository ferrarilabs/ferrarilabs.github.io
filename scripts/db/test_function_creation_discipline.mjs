...
test("o repositorio real passa no gate, e a divida declarada e exatamente a medida", () => {
  ...
  // 2026-08-22 (#292): `delete_canary_job` saiu porque a ordem de replay passou a ser a REAL — ela
  // nunca esteve exposta em producao, era o modelo que a via assim. Sobram os dois helpers, que sao
  // exposicao GENUINA ao vivo e saem pela remediacao da #282.
  const esperada = [];  // 2026-08-22: catraca ZERADA — `delete_canary_job` pela ordem real (#292),
                       // os dois helpers pela revogacao em producao (#282).
