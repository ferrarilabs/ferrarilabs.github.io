/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0b951659e14e100c8f1d83dfa1b48f0)
...
interface __BaseEnv_Env {
	...
	REPORT_GITHUB_PRIVATE_KEY: string;
	REPORT_ABUSE_HMAC_SECRET: string;
	ESTADO: DurableObjectNamespace<import("./src/index").EstadoDoIntake>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EstadoDoIntake";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REPORT_INTAKE_ENABLED" | "REPORT_GITHUB_OWNER" | "REPORT_GITHUB_REPO" | "REPORT_GITHUB_APP_ID" | "REPORT_GITHUB_INSTALLATION_ID" | "REPORT_GITHUB_PRIVATE_KEY" | "REPORT_ABUSE_HMAC_SECRET">> {}
}
